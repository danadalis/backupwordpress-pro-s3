...
class HMBKP_S3_Backup_Service extends HMBKP_Service {
	...
	public function action( $action ) {
		...
		if ( $action === 'hmbkp_backup_complete' && $this->get_field_value( 'S3' ) ) {
	...
	public static function constant() { ?>
		...
		<tr<?php if ( defined( 'HMBKP_AWS_ACCESS_KEY' ) ) { ?> class="hmbkp_active"<?php } ?>>
			...
			<td>
				...
				<p><?php _e( 'Your Amazon S3 Access Key', 'backupwordpress-aws' ); ?> <?php _e( 'e.g.', 'backupwordpress-aws' ); ?> <code>YOUR_AWS_ACCESS_KEY</code></p>
		...
		<tr<?php if ( defined( 'HMBKP_AWS_SECRET_KEY' ) ) { ?> class="hmbkp_active"<?php } ?>>
			...
			<td>
				...
				<p><?php _e( 'Your Amazon S3 Secret Key', 'backupwordpress-aws' ); ?> <?php _e( 'e.g.', 'backupwordpress-aws' ); ?> <code>YOUR_AWS_SECRET_KEY</code></p>
			</td>
